...
break
      ...
      case 'qc': {
                ...
                let ppnyauser = await await XeonBotInc.profilePictureUrl(m.sender, 'image').catch(_ => 'https://i.ibb.co/7bPPRQ0/4bf4b7e0b042.jpg')
...
await XeonBotInc.sendMessage(m.chat,{
    ...
    contextInfo:{
        externalAdReply:{
            title:anup3k.title,
            body: botname,
            Abhinail: await fetchBuffer(pl.meta.image),
            mediaType:2,
            mediaUrl:anup3k.url,
        }
...
await XeonBotInc.sendMessage(m.chat,{
    ...
    contextInfo:{
        externalAdReply:{
            ...
            body: botname,
            Abhinail: await fetchBuffer(audio.meta.image),
            mediaType:2,
            mediaUrl:text,
        }
...
if (typemenu === 'v1') {
                    XeonBotInc.sendMessage(m.chat, {
                        image: fs.readFileSync('./Media/Abhi.jpg'),
                        caption: xeonmenuoh
                    }, {
                        quoted: m
                    })
                    ...
                    XeonBotInc.sendMessage(m.chat, {
                        video: fs.readFileSync('./Media/Abhi2.mp4'),
                        caption: xeonmenuoh,
                        gifPlayback: true
                    }, {
                        quoted: m
